...
using MierukaPlus.Models;

namespace MierukaPlus.Controllers
{
    [Authorize]
    public class ProcessesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name")] Process process)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name")] Process process)
        {
            if (ModelState.IsValid)
            {
